...
> Simple symmetric text encryption (Fernet)

[![PyPI version](https://badge.fury.io/py/encrypt-text.svg)](https://pypi.org/project/encrypt-text/)
...
```bash
pip install encrypt-text
```

## Quick Start

```python
from encrypt_text import text

# Basic usage
result = text("your input here")
print(result)
```
...
from encrypt_text import batch
